...
- [Delivery](references/delivery.md) for dependency updates, deployment workflows, verification, commits, or pushes.
- [GitHub](references/github.md) for repository metadata, topics, features, Actions permissions, archive state, or security settings.
...
When following the shape of a template, explicitly follow its wording, ordering, and structure where they apply.
